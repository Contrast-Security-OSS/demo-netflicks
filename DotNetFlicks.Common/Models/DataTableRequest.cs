...
namespace DotNetFlicks.Common.Models
{
    public class DataTableRequest
    {
        ...
        public DataTableRequest(Controller controller, string sortOrder, string search, int? pageIndex, int? pageSize, string userId)
        {
            this.init(controller, sortOrder, search, pageIndex, pageSize, userId);
        }

        public DataTableRequest(Controller controller, string sortOrder, string search, int? pageIndex, int? pageSize)
        {
            this.init(controller, sortOrder, search, pageIndex, pageSize, "");
        }

        void init(Controller controller, string sortOrder, string search, int? pageIndex, int? pageSize, string userId)
        {
